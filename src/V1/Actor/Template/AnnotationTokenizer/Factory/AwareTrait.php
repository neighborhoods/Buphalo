...
namespace Neighborhoods\Buphalo\V1\Actor\Template\AnnotationTokenizer\Factory;

use LogicException;
use Neighborhoods\Buphalo\V1\Actor\Template\AnnotationTokenizer\FactoryInterface;
