...
namespace Neighborhoods\Buphalo\V1\Actor\Template\AnnotationTokenizer\Builder\Factory;

use LogicException;
use Neighborhoods\Buphalo\V1\Actor\Template\AnnotationTokenizer\Builder\FactoryInterface;
