...
namespace Neighborhoods\Buphalo\V1\Actor\Template\Compiler\Builder\Factory;

use LogicException;
use Neighborhoods\Buphalo\V1\Actor\Template\Compiler\Builder\FactoryInterface;
