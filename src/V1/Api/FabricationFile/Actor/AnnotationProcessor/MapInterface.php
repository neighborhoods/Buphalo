...
namespace Neighborhoods\Buphalo\V1\Api\FabricationFile\Actor\AnnotationProcessor;

use Neighborhoods\Buphalo\V1\Api\FabricationFile\Actor\AnnotationProcessorInterface;
