...
namespace Neighborhoods\Bradfab\SupportingActor\Template\Compiler\Strategy\Factory;

use LogicException;
use Neighborhoods\Bradfab\SupportingActor\Template\Compiler\Strategy\FactoryInterface;
