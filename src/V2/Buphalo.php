...
use LogicException;
use Neighborhoods\Buphalo\V2\Fabricator\FactoryInterface;
use Neighborhoods\Buphalo\V2\Protean;
use ReflectionClass;
...
class Buphalo implements BuphaloInterface
{
    ...
    protected const CAN_CACHE_CONTAINER = 'Neighborhoods_Buphalo_V2_Buphalo__CanCacheContainer';
