...
namespace Neighborhoods\Buphalo\V2\Actor\Template\Tokenizer\Builder\Factory;

use LogicException;
use Neighborhoods\Buphalo\V2\Actor\Template\Tokenizer\Builder\FactoryInterface;
